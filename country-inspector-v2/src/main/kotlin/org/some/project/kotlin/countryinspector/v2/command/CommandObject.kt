...
import org.some.project.kotlin.countryinspector.v2.country.City.Companion.CityCommand
import org.some.project.kotlin.countryinspector.v2.country.Country
import org.some.project.kotlin.countryinspector.v2.country.Country.Companion.CountryCommand
...
sealed class OverviewCommandObject: CommandObject<Overview> {
    ...
    companion object {
        ...
        data class HelpObject(val command: Overview.Companion.OverviewCommand?): OverviewCommandObject()
