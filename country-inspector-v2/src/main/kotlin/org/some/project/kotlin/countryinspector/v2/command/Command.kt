...
enum class OverviewCommand(
    ...
    Help(commandName = "help", description = "Shows the help for overview.")
}
...
enum class CountryCommand(
    ...
    CountryHelp(commandName = "help", description = "Shows the help for country.")
...
enum class CityCommand(
    ...
    Mayor(commandName = "mayor", description = "Tells the mayor's name."),
    ...
    CityHelp(commandName = "help", description = "Shows the help for city.")
